 ...
 * @Author laiyang
 * @Description:
 * @Date: Create in 0:12 2022/2/24
 * @Path: com.nowcoder.community.controller
 */
...
public class AlphaController {
    ...
    @ResponseBody
    public String saveStudent(String name,int age){//html 表单中的名字和parm的名字一直就会回传
